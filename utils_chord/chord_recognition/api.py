from chord_recognition.mir import DataEntry
from chord_recognition.mir import io
from chord_recognition.extractors.midi_utilities import get_valid_channel_count, is_percussive_channel, MidiBeatExtractor
from chord_recognition.extractors.rule_based_channel_reweight import midi_to_thickness_and_bass_weights
from chord_recognition.midi_chord import ChordRecognition
from chord_recognition.chord_class import ChordClass
import numpy as np
from chord_recognition.io_new.chordlab_io import ChordLabIO
from chord_recognition.io_new.downbeat_io import DownbeatIO
...
def process_chord(entry, extra_division):
    ...
    weights, success = midi_to_thickness_and_bass_weights(entry.midi)
    if success:
